...
a1 = Assignment.create(assigned_date: Time.now, due_date: '2014-05-01', client_id: c.id, assignment_type_id: t1.id)
a2 = Assignment.create(assigned_date: Time.now, due_date: '2018/04/21', client_id: c.id, assignment_type_id: t2.id)
n = Note.create(content: "needs revision", assignment_id: a1.id)